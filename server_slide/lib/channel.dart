import 'server_slide.dart';
import './controller/wordsController.dart';

class ServerSlideChannel extends ApplicationChannel {
  ...
  Controller get entryPoint {
    ...
    router.route("/words/[:id]").link(() => WordsController(context));
